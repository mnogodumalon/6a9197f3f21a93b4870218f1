#!/usr/bin/env node
// check-journey.mjs — is the agent's occupancy decision in src/config/journey.ts
// consistent with the app metadata?
//
...
console.log(`check-journey: OK (${seen.size} occupancy rule(s))`);
