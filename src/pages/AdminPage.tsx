...
const TESTERERFASSUNG_FIELDS = [
  ...
  { key: 'ergebnis', label: 'Ergebnis', type: 'string/textarea' },
  { key: 'bestanden', label: 'Test bestanden', type: 'bool' },
];

const ENTITY_TABS = [
  { key: 'testererfassung', pascal: 'Testererfassung' },
] as const;
...
export default function AdminPage() {
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    const raw: any[] = (() => {
      switch (entity) {
        case 'testererfassung': return TESTERERFASSUNG_FIELDS as any[];
        default: return [];
      }
    })();
